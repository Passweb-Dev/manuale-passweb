...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\lista_regole_vendita.bmp](./assets/media/image158.png){width="5.8180555555555555in"
...
- **Elimina Regola di Vendita** (
  ![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\pulsante_elimina_regola_vendita.bmp](./assets/media/image159.png){width="0.9222222222222223in"
  height="0.175in"} ): consente di eliminare la Regola di vendita
...
- **Modifica Regola di Vendita** (
  ![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\pulsante_modifica_regola_vendita.bmp](./assets/media/image160.png){width="1.0131944444444445in"
  height="0.1951388888888889in"} ): consente di modificare le
  caratteristiche della Regola di vendita attualmente selezionata in
  elenco.

- **Aggiungi Regola di Vendita** (
  ![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\pulsante_aggiungi_regola_vendita.bmp](./assets/media/image160.png){width="1.0131944444444445in"
  height="0.1951388888888889in"} ): consente di creare una nuova Regola
  di vendita

In particolare cliccando su quest'ultimo pulsante verrà visualizzata la
maschera "**Dati Regola di Vendita**"

![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\crea_regola_vendita_ebay.bmp](./assets/media/image161.png){width="5.532638888888889in"
