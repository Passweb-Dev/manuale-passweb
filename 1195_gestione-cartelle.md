...
La colonna sinistra presente all'interno della pagina "Documenti"
consente di visualizzare e gestire la struttura di cartelle e sotto
cartelle che possono essere utilizzate per organizzare i documenti
...
Il pannello "**Ricerca Cartelle**", presente nella parte alta di questa
...
Cliccando quindi su uno dei risultati presenti in elenco verrà aperta la
...
**ATTENZIONE!** i tre switch sopra indicati sono tutti attivi a default,
per cui la situazione di base è quella in cui all'interno dell'albero
sono visibili tutte le tipologie di cartelle effettivamente gestite.

Nei successivi capitoli di questo manuale verranno analizzate più nel
dettaglio le caratteristiche e le proprietà di ognuna delle tipologie di
cartelle sopra indicate
