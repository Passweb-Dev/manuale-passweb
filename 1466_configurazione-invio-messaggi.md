...
**Elimina** (
![](./assets/media/image18.png) ): consente di eliminare l'evento attualmente
selezionato in elenco

**Modifica** (
![](./assets/media/image19.png) ): consente di modificare l'evento
attualmente selezionato in elenco.

**Aggiungi** (
![](./assets/media/image20.png) ): consente di codificare un nuovo
