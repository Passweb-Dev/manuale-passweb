...
All'interno di questa sezione l'Agente avrà la possibilità di consultare
...
web, sarà necessario, ovviamente, esportare tali documenti in maniera
tale che possano essere gestiti anche all'interno del sito.

Per maggiori informazioni in merito a questo tipo di operazione si veda
anche la relativa sezione di questo manuale (*"Ordini -- Importazione
Ordini Creati da Gestionale"*)
