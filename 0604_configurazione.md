...
**Visibilità dei Box del Commento:** consente di abilitare la
...
- **Visibilità del Box della Text Area Commento tramite
  ...
  commenti effettuati da altri utenti sulla singola notizia. Come nel
...
- **Visibilità del Box della Text Area Commento e del Box dei Commenti
  ...
  commenti presenti sulla singola notizia verrà abilitata ai soli utenti
  autenticati.

**Commento obbligatorio:** selezionando questo parametro sarà poi
obbligatorio, per poter assegnare un voto alla specifica news, esprimere
anche un commento.
...
**Visualizza immagine Avatar:** consente di visualizzare o meno
...
**Visualizza Rating News:** consente di visualizzare, se selezionato, un
...
sarà necessario esprimere anche un commento.**

**Percorso immagine Stella Off/On:** consente di impostare le immagini
da utilizzare all'interno del controllo per il rating della notizia. A
...
- **Componenti CMS:** contiene quei componenti necessari a visualizzare
  i singoli elementi di ogni commento (es. Autore, Testo del Commento,
  Data Commento, Rating ecc...).

> **NOTA BENE:** per maggiori informazioni relativamente a come gestire
> i componenti CMS interni ad un componente "Commenti Associati" si veda
