...
**ATTENZIONE!** duplicando un Componente Posizionato in assoluto
l'originale e la copia saranno sovrapposti avendo le stesse
coordinate**.** In questo caso si dovrà dunque agire sulle sue
coordinate per visualizzare entrambi in maniera distinta.
