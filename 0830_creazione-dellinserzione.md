...
Per poter pubblicare su eBay articoli con un massimo di due elementi
varianti (es. taglie e colori) **è necessario utilizzare apposite
inserzioni** definendo in maniera corretta tutte le specifiche
...
delle seguenti opzioni**: Attributo eBay, Attributo Passweb**,
**Personalizzato**
...
**ATTENZIONE! Le inserzioni abilitate per poter gestire articoli a
taglie / colori (o comunque con un massimo di due elementi varianti),
potranno essere utilizzate solo ed esclusivamente per la pubblicazione
di questa particolare tipologia di articoli**
