# COMPONENTI PER IL FORM - CAMPO LISTA CHECKBOX



Il Componente **"Campo Lista Checkbox"** permette di inserire una serie
di etichette seguite da altrettante caselline da spuntare, in sostanza è
simile al campo Radio (spiegato precedentemente) ma, a differenza di
...
- Il Controllo (ossia la lista di Check Box)
