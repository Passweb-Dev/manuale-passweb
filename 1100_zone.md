...
- **Modifica Zona**
  (![](./assets/media/image461.png) )**:** consente di modificare la Zona
  attualmente selezionata in elenco

- **Elimina Zona**
  (![](./assets/media/image462.png) )**:** consente di eliminare la Zona
  attualmente selezionata in elenco

- **Copia Zona**
  (![](./assets/media/image463.png) )**:** consente di copiare la Zona
  attualmente selezionata in elenco

- **Aggiungi Zona**
  (![](./assets/media/image464.png) )**:** consente di aggiungere una nuova
  Zona.
...
**Elimina Area** (
![](./assets/media/image468.png) ): consente di eliminare l'Area di
Spedizione attualmente selezionata

**Svuota** (
![](./assets/media/image469.png) ): consente di svuotare l'intera tabella
