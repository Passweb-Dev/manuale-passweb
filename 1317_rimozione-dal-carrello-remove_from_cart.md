...
in cui verrà rimosso un articolo dal carrello
...
*event_label: 'Remove from Cart Magic Mouse' ,*
...
- **event_label:** Remove from Cart + Titolo del prodotto rimosso dal
  carrello
...
- **value:** quantità (negativa) rimossa dal carrello (valore di
  Default), il corrispondente valore monetario (prezzo ivato), oppure il
  valore personalizzato impostato per il parametro "**GA4 --
  remove_from_cart**" presente alla pagina "***Sito Preferenze***" del
