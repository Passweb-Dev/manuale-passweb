...
configurazione del componente "Prenotazione Custom", consente di
...
suddivisa la riga di dettaglio della prenotazione.

![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\prenotazione_custom_configurazione_1_res.bmp](./assets/media/image348.png){width="4.613194444444445in"
...
> all'interno della riga di dettaglio della prenotazione.**

![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\contenuti_tabs_contenitore_res.bmp](./assets/media/image167.png){width="4.355555555555555in"
...
> "Prenotazione Custom" diventerà a tutti gli effetti un vero e proprio
...
> dei componenti, portarsi col mouse sul componente e, alla comparsa del
> R.O.C., cliccare sull'icona '**Accedi ai componenti interni**'.
>
> Nello specifico sarà possibile inserire all'interno della Prenotazione
> Custom due diverse tipologie di componenti:
...
- **Componenti Comuni:** si tratta di semplici componenti di tipo
  ...
  ovviamente essere contestualizzato in base allo specifico servizio /
...
- **Componenti Ecommerce:** si tratta di veri e propri componenti
  ...
  informazioni in base allo specifico servizio / trattamento prenotato.
