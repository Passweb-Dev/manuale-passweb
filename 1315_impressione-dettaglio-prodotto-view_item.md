# IMPRESSIONE DETTAGLIO PRODOTTO -- VIEW_ITEM
...
*event_label: 'Detail View Item Magic Mouse',*
...
- **event_label:** Detail View Item + Titolo del prodotto
...
- **value:** prezzo di vendita dell'articolo (valore di Default) oppure
  il valore personalizzato impostato per il parametro "**GA4
