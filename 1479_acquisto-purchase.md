...
**Modalità invio**: Server, Client (se attive entrambe le modalità
l'invio lato server esclude quello lato client)

**Generazione dell' evento**: l'evento in esame verrà attivato ogni
volta in cui verrà concluso un' ordine
...
*eventID / event_id: Purchase-20221110145456-779*
...
- **value:** totale documento (valore di Default) oppure il valore
  personalizzato impostato per il parametro "**purchase**" presente alla
...
- **order_id**: id della transazione Passweb

- **num_items**: numero complessivo dei prodotti in ordine
