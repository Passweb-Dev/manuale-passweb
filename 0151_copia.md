...
presenti sulla Variante di destinazione (come avviene invece nelle
operazioni di importazione modello o di ripristino copie di backup). La
sezione CSS, così come quella Javascript di un layout copiato, dunque, è
in tutto e per tutto identica a quella del Layout sorgente.**
