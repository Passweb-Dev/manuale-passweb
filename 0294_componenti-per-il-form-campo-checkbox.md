# COMPONENTI PER IL FORM - CAMPO CHECKBOX



Il Componente **"Campo Checkbox"** consente l'inserimento di una singola
etichetta seguita da una casellina da spuntare (checkbox). Rilasciando
...
- Il Controllo (ossia il Check box)
