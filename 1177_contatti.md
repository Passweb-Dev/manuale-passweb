...
All'interno di questa sezione è possibile visualizzare tutti gli
indirizzi, anagrafici e di spedizione, dell'utente selezionato,
...
"**Sito -- Preferenze**" del Wizard (tab "**Integrazioni**", sezione
"**Google Map API**"). Per maggiori informazioni in merito si veda anche
quanto indicato nel relativo capitolo di questo manuale ("*Sito --
Preferenze -- Integrazioni -- Google Maps API*")

Il primo degli indirizzi in elenco (con sfondo più scuro) è quello
