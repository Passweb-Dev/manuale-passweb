...
Nell'ambito dell'integrazione tra Passweb e Prestashop occorre
considerare due diversi tipi di sincronizzazione:

- **Sincronizzazione tra Passweb e Prestashop:** può essere effettuata
  in maniera manuale e riguardare solamente il trasferimento di ordini,
  articoli o clienti da Prestashop verso Passweb e da qui verso il
...
> Passweb e Prestashop possono essere diversi dipendentemente dal fatto
> di considerare sincronizzazioni manuali o schedulate
>
> In ogni caso durante le operazioni di sincronizzazione tra Passweb e
> Prestashop **NON verranno mai aggiornate le Liste di Vendita**
> definite su Passweb.
>
...
> Come le sincronizzazioni tra Passweb e Prestashop anche le
...
>
> A differenza invece delle sincronizzazioni tra Passweb e Prestashop
...
##### SINCRONIZZAZIONE PASSWEB -- PRESTASHOP

Come evidenziato nel precedente capitolo di questo manuale le
sincronizzazioni tra Passweb e Prestashop possono avvenire in maniera
...
"**Gestione Account**" dopo aver selezionato l'Account Prestashop in
esame.

![\\\\doctohelp\\D\\ManPassweb_Ecommerce\\Videate\\magento_sincro_manuale.bmp](./assets/media/image709.png){width="5.2340277777777775in"
...
- ordini Prestashop che tramite Passweb vengono inseriti nel gestionale
  Passepartout

- anagrafiche di nuovi clienti (collegate ovviamente a specifici ordini
  Prestashop) ed eventuali indirizzi di spedizione, inseriti anch'essi,
  tramite Passweb, nel gestionale Passepartout

- anagrafiche di nuovi articoli presenti sugli ordini Prestashop ma non
...
- Una volta terminata l'importazione in Passweb di eventuali nuovi
  ...
  di inserire immediatamente i nuovi ordini Prestashop anche all'interno
  del gestionale
...
- Se, a seguito della Sincronizzazione Parziale tra Passweb ed il
  ...
  che utilizzano l'Account Prestashop in esame.
...
**ATTENZIONE!** Il processo di sincronizzazione tra Passweb e Prestashop
...
con cui eseguire la sincronizzazione Passweb -- Prestashop (giornaliera,
...
- informazioni relative al cambio di stato avvenuto per determinati
  ordini all'interno del gestionale Passepartout e conseguente cambio di
  stato anche per gli ordini Prestashop

Nello specifico in relazione alla **Sincronizzazione "Passweb --
Prestashop" schedulata** occorre infatti sottolineare che:
...
- Una volta terminata la Sincro Ordini e la Sincro Clienti verrà
  ...
  immediatamente i nuovi ordini Prestashop e i nuovi dati anagrafici
  anche all'interno del gestionale
...
- Se, a seguito delle suddette operazioni dovessero essere inseriti nel
  ...
  Inserzioni che utilizzando l'Account Prestashop in esame.
...
- Al termine della Sincro Ordini e della Sincro Clienti verranno
  ...
  per effettuare i corrispondenti cambi di stato anche sugli ordini
  Prestashop.
...
- Acquisizione di nuovi ordini da Prestashop

- Cambio di stato degli ordini e conseguente passaggio di stato anche
  sugli ordini Prestashop
...
- **Sincro Ordini tra Passweb e Prestashop:** durante il processo di
  ...
  Prestashop descritta nel capitolo precedente.

> In particolare poi il processo di importazione ordini da Prestashop su
...
- **Cambio di stato degli ordini Prestashop:** nel caso in cui Passweb,
  a seguito di una Sincronizzazione con il gestionale, dovesse rilevare
  che alcuni ordini, originariamente acquisiti da Prestashop, hanno
  subito un cambio di stato (es. sono stati annullati, bollati o
  fatturati) verranno avviate automaticamente tutte le procedure
  necessarie per effettuare i corrispondenti cambi di stato anche sugli
  ordini Prestashop

> Per maggiori informazioni relativamente alle diverse operazioni
> effettuabili su ordini acquisiti da Prestashop si veda anche quanto
