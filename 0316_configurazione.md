...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\contenuti_accordion_configurazione_res.bmp](./assets/media/image185.png){width="5.149305555555555in"
...
- **Mantieni chiusi i pannelli al caricamento della pagina:** se
  impostato a SI, al caricamento della pagina web tutti i Pannelli del
  componente appariranno chiusi e sarà quindi necessario cliccare su
  ciascuna intestazione per visualizzare i contenuti del relativo
  pannello.

> Se impostato a NO, al caricamento della pagina, il componente apparirà
> con il primo pannello già aperto
