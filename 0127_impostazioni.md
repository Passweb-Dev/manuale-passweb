...
All'interno di questa sezione del Wizard è possibile

- Prelevare l'Api Key necessaria per poter effettuare l'autenticazione
  all' App Passweb Monitor -- campo "**Api Key**" della sezione
...
capitolo "*Passweb Monitor*" di questo manuale
