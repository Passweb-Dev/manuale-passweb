...
evidenziato, cliccando sul pulsante "**Genera Token**" verremo
...
sarà sufficiente cliccare sul pulsante "**Salva**" posto nella parte
bassa della pagina per salvare le impostazioni settate e,
successivamente, utilizzare il pulsante "**Test Invio Mail**" in maniera
tale da verificare che la connessione alla casella di posta indicata
avvenga correttamente e che le diverse mail gestite dall'applicativo
possano quindi essere inviate senza problemi.
