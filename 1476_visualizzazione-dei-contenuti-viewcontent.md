# VISUALIZZAZIONE DEI CONTENUTI -- ViewContent



**Nome Evento**: ViewContent
...
*eventID / event_id: ViewContent-20221110145456-779*
...
- **content_ids:** codice del prodotto visualizzato

- **content_name:** titolo del prodotto visualizzato

- **content_category**: percorso della categoria merceologica di
  appartenenza dell'articolo visualizzato
...
- **currency:** codice ISO della valuta in uso al prodotto visualizzato

- **value:** prezzo di vendita ivato dell'articolo (valore di Default)
  oppure il valore personalizzato impostato per il parametro
  "**view_item**" presente alla pagina "***Sito Preferenze***" del
...
> "*ViewContent-20221110145456-779*")
