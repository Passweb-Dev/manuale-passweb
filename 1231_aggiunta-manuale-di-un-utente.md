...
E' possibile aggiungere utenti alla propria lista in maniera manuale
operando direttamente all'interno di MailChimp.

Per poter far questo è necessario, innanzitutto, aprire il menu
...
confermare la registrazione del nuovo utente.

In alternativa è possibile accedere alla maschera di aggiunta nuovo
