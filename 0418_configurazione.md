...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\componente_ecommerce_scheda_categoria_configurazione_res.bmp](./assets/media/image276.png){width="4.638194444444444in"
...
**il Componente "Scheda Categoria" può essere considerato a tutti gli
...
visualizzate al suo interno. Tali campi, in ogni caso, per poter esser
gestiti liberamente, dovranno inevitabilmente esser trattati a loro
volta come Componenti autonomi editabili singolarmente.

Una volta inserito quindi il Componente "Scheda Categoria" all'interno
di una delle pagine consentite, per poterlo poi personalizzare sarà
...
In particolare all'interno di un componente di tipo "Scheda Categoria"
...
- **Componenti E-Commerce:** contiene tutti i componenti E-Commerce,
  ...
  informazioni gestionali dovranno essere visualizzate all'interno del
  componente
