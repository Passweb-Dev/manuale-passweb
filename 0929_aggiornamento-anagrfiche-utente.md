...
Magento da parte di un utente che non è ancora presente tra le
anagrafiche di Passweb, verrà creata automaticamente anche la sua
anagrafica.
...
- se l'utente presente nell'ordine in arrivo da Magento **è un utente
...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\aggiorna_clienti_magento_1.bmp](./assets/media/image814.png){width="5.792361111111111in"
height="3.422222222222222in"}
...
> Passweb -- Magento schedulata secondo i parametri impostati
