# INIZIO DI ACQUISTO -- InitiateCheckout
...
volta in cui verrà effettuato l'accesso alla pagina di checkout
iniziando quindi il processo di ordine
...
*eventID / event_id: InitiateCheckout-20221110145456-779*
...
- **value:** 1 (valore di Default) oppure il valore personalizzato
  impostato per il parametro "**begin_checkout**" presente alla pagina
...
> "*InitiateCheckout-20221110145456-779*")
