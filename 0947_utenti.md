...
- **Mail** (
  ![](./assets/media/image42.png) ): consente, se cliccato, di aprire
...
- **Telefono** (
  ![](./assets/media/image43.png) ): consente, se cliccato, di avviare
...
- **Whatsapp** (
  ![](./assets/media/image44.png) ): consente, se cliccato, di aprire
...
![](./assets/media/image46.png) ) e "**Filtri Avanzati**" (
![](./assets/media/image47.png) ) presenti nella contestuale barra degli strumenti.
...
**Filtri** **Avanzati**(
![](./assets/media/image47.png) ) : consente, se cliccato, di aprire un pannello di
...
(![](./assets/media/image64.png) ): consente di gestire in maniera
...
**Esportazione Utenti**
(![](./assets/media/image66.png) ): consente di esportare **in formato
...
**Elimina Utente**
(![](./assets/media/image68.png) ): consente di eliminare, dal database di
...
**Modifica Utente** (
![](./assets/media/image10.png) ): consente di accedere all'anagrafica
...
![](./assets/media/image69.png) ): visibile solo nel caso in cui
