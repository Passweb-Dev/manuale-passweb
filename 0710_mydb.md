...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\tabelle_anagrafica_mydb.bmp](./assets/media/image232.png)

- **tabelle con Estensione Univoca** in cui per ogni singolo articolo /
  cliente viene definito un singolo record

![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\tabelle_anagrafica_mydb_2.bmp](./assets/media/image233.png)
...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\permesso_gestione_mydb.bmp](./assets/media/image234.png)

Una volta effettuato l'accesso a questa sezione del Wizard verrà quindi
visualizzata la maschera Campi MyDB

![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\campi_mydb.bmp](./assets/media/image235.png)
...
- **Modifica Campo** **(**
  ![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\pulsante_modifica_campo_res.bmp](./assets/media/image236.png) **):** consente di modificare la
...
- **Elimina Campo** **(**
  ![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\pulsante_elimina_campo.bmp](./assets/media/image237.png) **):** consente di eliminare il campo
...
- **Aggiungi Campo** **(**
  ![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\pulsante_aggiungi_campo.bmp](./assets/media/image238.png) **):** consente di creare un nuovo campo che dovrà
