...
"Prodotti Correlati", consente se selezionato, di visualizzare, lato
...
ad esempio per il componente "Catalogo E-Commerce").

La combo box di selezione sarà preceduta da un testo indicativo, "Ordina
per:", modificabile nella sezione "Gestione Testi/Messaggi Sito" del
Wizard.
...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\modifica_catalogo_ecommerce2_res.bmp](./assets/media/image81.png){width="4.636111111111111in"
...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\icona_aggiungi.bmp](./assets/media/image82.png){width="0.18819444444444444in"
...
l'elemento di ordinamento che si sta codificando. E' possibile indicare
...
In fine va anche ricordato che i campi sulla base dei quali poter
