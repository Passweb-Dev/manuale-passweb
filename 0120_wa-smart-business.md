...
**italiana** che offre strumenti per la gestione di messaggistica su
**WhatsApp Business Platform (API in cloud)**, con funzioni di
...
Grazie a questa integrazione è possibile gestire da Passweb l'invio
automatico di messaggi Whatsapp in relazione ai seguenti eventi:
...
Tutte le altre funzionalità offerte dalla piattaforma (es. collegamento
al Catalogo Facebook, messaggi Marketing per campagne prodotti ...)
potranno essere gestiti direttamente dal backend di WA Smart Business

Per maggiori informazioni in merito all'integrazione Passweb -- WA Smart
Business e alle possibilità da essa offerte, si rimanda al relativo
capitolo "*Passweb e WA Smart Business*" di questo manuale.
