...
All'interno della sezione "**Shortcut**" sono riportati invece una serie
...
"**Configurazione Menu**" evidenziata in figura, consentono
rispettivamente di:
...
**ATTENZIONE! non è ovviamente possibile aggiungere, eliminare o
modificare le voci del "Menu Completo"**

E' invece possibile creare nuovi Shortcut anche a partire da una
qualsiasi voce di menu predefinita. Per far questo è sufficiente
...
- **La stella colorata** indica che è già stato creato, per la voce di
  menu in questione, il relativo Shortcut che potrà quindi essere
  visualizzato e gestito nel corrispondente elenco (pulsante
  "Shortcut").

- **La stella vuota** indica invece che per la relativa voce di menu non
  è ancora stato creato nessuno Shortcut.

**ATTENZIONE!** **E' sempre possibile attivare / disattivare uno
...
- **Titolo**: consente di definire l'etichetta del collegamento rapido
  che si sta configurando

<!-- -->

- **Icona**: consente di definire l'eventuale icona da associare al
  relativo shortcut.

> **Sono gestite solamente icone di Fontawesome 5 in versione free**
> (<https://fontawesome.com/v5/search?m=free>)
>
> **ATTENZIONE!** E' necessario inserire il nome dell'icona da
...
> indicare all'interno del campo "Icona" il nome "wrench" (come
> evidenziato in figura)

- **Url**: consente di indicare l'url di destinazione del collegamento
  rapido che si sta codificando.

> In questo senso è bene sottolineare che:

- **Gli url che iniziano per dominiosito/Wizard** verranno aperti
  direttamente all'interno dell'App Passweb Monitor

- **Tutti gli altri url** verranno invece aperti nel browser in uso sul
  dispositivo mobile e quindi al di fuori dell'App

> **ATTENZIONE!** per gli Shortcut creati a partire da una voce di menu
> predefinita non sarà ovviamente possibile modificare questo campo

- **Colore**: consente di definire il colore da utilizzare per l'icona
  associata al relativo collegamento rapido, colore questo che, nello
  specifico verrà poi utilizzato come colore della corrispondente icona

L'elenco di Shortcut creati a partire da questa sezione del Wizard potrà
poi essere mostrato, all'interno di Passweb Monitor, in due diverse
...
**ATTENZIONE!** cliccando sul pulsante in esame verranno eliminati
definitivamente tutti gli shortcut attualmente gestiti e presenti in
elenco

Nel momento in cui l'esigenza dovesse essere dunque quella di eliminare
un singolo shortcut sarà necessario procedere in modo diverso. Nello
specifico:

- Se lo shortcut da eliminare dovesse essere stato generato a partire da
  una voce di menu predefinita sarà necessario, per prima cosa,
  visualizzare il menu completo con l'elenco di tutte le voci
  predefinite. Fatto questo sarà poi sufficiente individuare la voce di
  menu corrispondente allo shortcut da eliminare e cliccare sull'icona
  raffigurante una piccola stella colorata posta al suo fianco.

- Se lo shortcut da eliminare dovesse essere uno dei collegamenti rapidi
  di tipo custom precedentemente creato, sarà sufficiente selezionarlo e
...
impostabili anche in fase di modifica di quello stesso shortcut)

I pulsanti "Salva" ed "Elimina" consento, rispettivamente di salvare ed
eliminare in maniera definitiva il corrispondente shortcut custom
