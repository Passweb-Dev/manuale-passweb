...
configurazione della Wishlist Custom, consente di definire e gestire i
...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\wishlist_custom_configurazione_1_res.bmp](./assets/media/image194.png){width="5.134722222222222in"
...
> sempre gli stessi per ogni singola riga articolo presente nella
> wishlist**
...
> all'interno di ogni singola riga articolo presente nella Wishlist.**
...
>
> In sostanza dunque, nelle condizioni indicate, il componente "Wishlist
...
> dei componenti, portarsi col mouse sul componente Wishlist Custom e,
> alla comparsa del R.O.C., cliccare sull'icona '**Accedi ai componenti
> interni**'.
>
> Nello specifico sarà possibile inserire all'interno della Wishlist
> Custom diverse tipologie di componenti:
...
- **Componenti Comuni:** si tratta di semplici componenti di tipo
  ...
  articolo presente nella wishlist

- **Componenti per il Form:** si tratta di controlli di input, nel caso
  specifico un "**Campo Lista Valori**" e un "**Campo Area di Testo**",
  che potranno essere utilizzati unicamente in relazione alle gestione
  delle Liste Regalo.
...
- **Componenti Ecommerce:** si tratta di veri e propri componenti
  ...
  informazioni in base allo specifico articolo presente nella wishlist.
