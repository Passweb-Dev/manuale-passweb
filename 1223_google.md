...
**Tipo di sicurezza**: OAuth2

**Tipologia di OAuth**: Google

**Nome Utente OAuth**: indirizzo mail della casella da cui verranno poi
inviate le mail (es. mioindirizzo@gmail.com)
...
evidenziato, cliccando sul pulsante "**Sign in with Google**" verremo
...
dichiarato anche nella maschera di configurazione del Wizard di Passweb,
sarà necessario concedere all'App "**Passweb Mail**" le autorizzazioni
richieste, autorizzazioni queste indispensabili per consentire a Passweb
...
Arrivati a questo punto sarà quindi sufficiente cliccare sul pulsante
"**Salva**" posto nella parte bassa della pagina per salvare le
impostazioni settate e, successivamente, utilizzare il pulsante "**Test
Invio Mail**" in maniera tale da verificare che la connessione alla
casella di posta indicata avvenga correttamente e che le diverse mail
gestite dall'applicativo possano quindi essere inviate senza problemi.
