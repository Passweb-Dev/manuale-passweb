# VARIABILE "GADS -- DLV REMARKETING_ADS.VALUE"



**Tipologia della variabile**: variabile di livello dati

**Nome della variabile**: GADS -- DLV remarketing_ads.value

**Contenuto della variabile**: somma dei prezzi ivati dei prodotti
coinvolti nell'evento di remarketing dinamico

**Tag in cui utilizzare la variabile**: Tag di Remarketing Dinamico

La variabile in esame consente di prelevare dal data layer del relativo
evento la somma dei prezzi ivati di tutti i prodotti coinvolti
...
4.  Assegnare un nome alla variabile (es. "**GADS -- DLV
