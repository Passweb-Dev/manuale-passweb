# VARIABILE "UPD -- DLV USER_DATA.SHA256_EMAIL_ADDRESS"



**Tipologia della variabile**: variabile di livello dati

**Nome della variabile**: UPD -- DLV user_data.sha256_email_address

**Contenuto della variabile**: email crittata dell'utente attualmente
connesso al sito

La variabile in esame consente di prelevare dal dataLayer di Passweb il
valore, hashato, dell'Email dell'utente attualmente connesso al sito
...
4.  Assegnare un nome alla variabile (es. "**UPD -- DLV
