# AGGIUNTA IN CARRELLO -- AddToCart
...
volta in cui viene aggiunto un articolo in carrello
...
*eventID / event_id: AddToCart-20221110145456-779*
...
- **content_ids:** codice del prodotto aggiunto in carrello

- **content_name:** titolo del prodotto aggiunto in carrello

- **content_category**: percorso della categoria merceologica di
  appartenenza dell'articolo aggiunto in carrello
...
- **value:** quantità con cui l'articolo è stato aggiunto in carrello
  ...
  parametro "**add_to_cart**" presente alla pagina "***Sito
