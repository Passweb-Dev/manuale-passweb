...
in cui verrà visitata la pagina Carrello
...
- **value:** totale carrello ivato (valore di Default) oppure il valore
  personalizzato impostato per il parametro "**GA4 -- view_cart**"
