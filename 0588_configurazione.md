...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\modifica_dettaglio_news_res.bmp](./assets/media/image9.png){width="4.610416666666667in"
...
**il Componente "Dettaglio News" può essere considerato a tutti gli
...
In particolare all'interno di un componente di tipo "Dettaglio News"
...
> i componenti CMS interni ad un componente "Dettaglio News" si veda la
...
L'inserimento di questi componenti all'interno del Componente Dettaglio
