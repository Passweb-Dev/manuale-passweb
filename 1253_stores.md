...
![](./assets/media/image110.png) ) che comparirà in testata alla colonna
...
- **Modifica Store**
  (![](./assets/media/image112.png) )**:** consente di modificare lo Store
  attualmente selezionato in elenco

- **Elimina Store**
  (![](./assets/media/image113.png) )**:** consente di eliminare lo Store
  attualmente selezionato in elenco

- **Aggiungi Store**
  (![](./assets/media/image114.png) )**:** consente di codificare un nuovo
  Store.
...
- **Connetti** (
  ![](./assets/media/image118.png) ) -- **visualizzato solo dopo aver
...
- **Disconnetti** (
  ![](./assets/media/image122.png) ): consente di effettuare la
...
- **Sincro Articoli** (
  ![](./assets/media/image123.png) ): consente di avviare manualmente la
...
- **Sincro Clienti** (
  ![](./assets/media/image124.png) ): consente di avviare manualmente la
