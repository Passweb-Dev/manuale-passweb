...
**Esporta** (
![Videate\\pulsante_esporta.bmp](./assets/media/image313.png) ): consente di esportare, all'interno di un apposito
...
**Importa** (
![Videate\\pulsante_importa.bmp](./assets/media/image466.png) ): consente di importare in maniera massiva,
