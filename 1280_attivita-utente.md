...
Oltre al dettaglio sulle attività effettuate da un utente durante una
specifica sessione di navigazione, volendo è possibile, solo per utenti
registrati, accedere anche al dettaglio delle azioni effettuate da
quello specifico utente durante TUTTE le sue sessioni di navigazione
(raggruppando quindi questi dati non più per sessione ma per utente)

Per far questo sarà necessario accedere come sempre alle statistiche
relative ai visitatori del sito, filtrare le visite dei soli utenti
...
TUTTE LE SUE SESSIONI DI LAVORO** (l'ultima colonna della tabella
riporta anche l'Id della specifica sessione in cui è stata registrata la
