...
- **Elimina** (
  ![](./assets/media/image95.png) )**:** consente di eliminare il codice
  Gift Card attualmente selezionato

- **Modifica** (
  ![](./assets/media/image116.png) )**:** consente di accedere alle
...
- **Importa da File** (
  ![](./assets/media/image319.png) )**:** consente di importare in maniera
...
- **Esporta** (
  ![](./assets/media/image124.png) )**:** consente di esportare
  all'interno di un file .csv i codici Gift Card attualmente presenti in
  elenco

- **Transazioni** (
  ![](./assets/media/image320.png) )**:** consente di visualizzare l'elenco delle
...
- **Invia Mail di Attivazione** (
  ![](./assets/media/image322.png) ) **-- solo per Gift Card Virtuali:**
...
- **Invia Mail Assegnazione** (
  ![](./assets/media/image324.png) ) **-- solo per Gift Card Virtuali e
...
- **Link Condivisione** (
  ![](./assets/media/image325.png) ) **-- solo per Gift Card Virtuali:**
...
- **Nuovo** (
  ![](./assets/media/image326.png) )**:** consente di codificare un nuovo
  codice Gift Card
