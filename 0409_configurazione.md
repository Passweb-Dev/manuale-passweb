...
![\\\\doctohelp\\D\\ManPassweb_Ecommerce_Sviluppo\\Videate\\punti_premio_configurazione.bmp](./assets/media/image256.png){width="4.65in"
...
- **Numero di elementi da visualizzare per pagina:** consente di
  impostare il numero di elementi (Transazioni) che dovranno essere
  visualizzati, all'interno del componente, per ogni singola pagina
